...
export class ResourceService {
  ...
  insert(data:any){
    return this.http.post<any>(`${environment.apiUrl}/wp/v2/resources/`,data);
  }
  update(data:any,id:Number | string){
    return this.http.post<any>(`${environment.apiUrl}/wp/v2/resources/${id}`,data);
  }
  delete(item:any){
    return this.http.delete<any>(`${environment.apiUrl}/wp/v2/resources/${item.id}`);
  }
